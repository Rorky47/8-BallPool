import type { BallId, BallState, GameState, TableState } from "@eightball/shared";
...
export function createInitialBalls(table: TableState = DEFAULT_TABLE): BallState[] {
...
export function createInitialGameState(table: TableState = DEFAULT_TABLE): GameState {
  return {
    tick: 0,
    phase: "aim",
    currentPlayer: 0,
